...
stackS (Sta containers n) container| n > 0 = Sta (container:containers) (n-1)
...
holdsS (Sta containers n) container ruta   
    ...
    |otherwise = inOrderR ruta (destinationC container) (destinationC (last containers))  --https://stackoverflow.com/questions/7376937/fastest-way-to-get-the-last-element-of-a-list-in-haskell
