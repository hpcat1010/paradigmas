...
pesadotest = [("test de holdsS stackpesado containerPesado testroute1", holdsS stackpesado containerPesado testroute1)
              ,("test de holdsS stackpesado containerPesado testroute2", not(holdsS stackpesado containerPesado testroute2))]
-- test :: [Bool]
test = [ ( "test de destination"     , destinationC (container1) == "aire")
        ...
        ,("test peso pesado",netS stackpesado == 19) 
        ,( "test de holdS stackpesado", holdsS stackpesado containerPesado testroute1 )
...
vestest = [ ( "test de freeCellsV Ves stack1Empty testroute", freeCellsV testVessel == 2)
           ...
           ,("test de netV Ves stack1Empty testroute", freeCellsV (newV 2 2 testroute1)==4)
